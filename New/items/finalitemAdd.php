...
<td><input type="text" style="width: 265px; height: 60px;" name="icode" placeholder="001" required>
</td>
 </tr>
  <tr>
  <td><h2>Item Name </h2></td>
  <td><input type="text" style="width: 265px; height: 60px;" name="iname" placeholder="B01" required></td>
  </tr>
 ...
 <td><select  type="text" style="width: 265px; height: 60px;" name="ittype" required>
  ...
  <tr><td><h2>Supplier Code:</h2></td>
    <td><select  type="text" style="width: 265px; height: 60px;" name="scode" required>
  ...
  <tr><td><h2>Item Describtion :</h2></td>
    <td><input type="text" style="width: 265px; height: 60px;" name="ides" placeholder=" add more details" required></td>
  </tr>

  </tr>
  <tr><td><h2>Unit Cost:</h2></td>
    <td><input type="text" style="width: 265px; height: 60px;" name="icost" placeholder=" AB001" required></td>
  </tr>
