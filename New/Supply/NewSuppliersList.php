...
if($resultCheck>0){
  $i=1;
   ...
   <td><?php echo $row-> Sbank;?></td>
   <td><?php echo $row-> Sphone;?></td>
   <td><?php echo $row-> Sdate;?></td>
   <td><?php echo $row-> ITtype;?></td>

   <td> 
		<a href="EditSupply.php?edited=1&Scod=<?php echo $row->SCode; ?>">Edit</a>
		<a href="NewSuppliersList.php?delected=1&Scod=<?php echo $row->SCode; ?>">delect</a>
   </td>
...
<h1>List Of Suppliers Details..</h1>
