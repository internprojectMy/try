...
<form name="form1" action="../include/Supplierssubmit.php" method="POST">
	<table>
     <tr>
	  ...
	  <td> <input type="text" style="width: 265px; height: 60px;" name="Scod" value="<?php echo $row->SCode; ?> "required></td>
	  </tr>
	  <tr>
	  <td> <h2>Supplier Name:</h2> </td>
	  <td> <input type="text" style="width: 400px; height: 60px;" name="Snam" value="<?php echo $row->Sname; ?> " required></td>
	  </tr>

	  <tr>
	  <td> <h2>Supplier Address:</h2> </td>
	  <td> <input type="text" style="width: 465px; height: 60px;" name="Saddres" value="<?php echo $row->SAddress; ?> " required></td>
	  </tr>

	  <tr>
	  <td><h2> City:</h2> </td>
	  <td> <input type="text" style="width: 265px; height: 60px;" name="Scit" value="<?php echo $row->SCity; ?> " required=""></td>
	  </tr>
      
      <tr>
	  <td><h2> E-mail:</h2> </td>
	  <td> <input type="text" style="width:380px; height: 60px;" name="Semai" value="<?php echo $row->Semail; ?> " required></td>
	  </tr>

	  <tr>
	  <td><h2> Account No:</h2> </td>
	  <td> <input type="text" style="width: 265px; height: 60px;" name="Saccoun" value="<?php echo $row->Saccount; ?> " required ></td>
	  </tr>
     <tr>
	  <td><h2> Bank Name:</h2> </td>
	  <td> <input type="text" style="width:320px; height: 60px;" name="Sban"  value="<?php echo $row->Sbank; ?> " required></td>
	  </tr>

	  <tr>
	  <td><h2> Phone No:</h2> </td>
	  <td> <input type="text" style="width: 300px; height: 60px;" name="Sphon" value="<?php echo $row->Sphone; ?> " required></td>
	  </tr>

	  <tr>
	  <td><h2> Date:</h2> </td>
	  <td> <input type="Date" style="width: 265px; height: 60px;" name="Sdat" value="<?php echo $row->Sdate; ?> " required></td>
	  </tr>
  ...
  <option value="Causeway floorPaints">Causeway floorPaints</option>
	  ...
	  <tr>
	  <td colspan="2" align="center "> <input class="button" type="submit" style="width: 150px; height: 60px;" name="submit" value=" Update"></td>
	  </tr>
   </table>				
	</form>
</div>
