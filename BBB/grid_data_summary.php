...
$data = array();
 ...
 while ($row_1 = mysqli_fetch_assoc($sql_1)) {
    $data[] = array( 
 	'id' => $row_1['summary_id'],
 	'ground_id' => $row_1['groundname'],
 	'team_id' => $row_1['teamname'],
	...
	while ($row_1 = mysqli_fetch_assoc($sql_1)){
		...
		$data['ground_id'] = $row_1['groundname'];
		$data['team_id'] = $row_1['teamname'];
