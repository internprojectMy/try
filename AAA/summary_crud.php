...
if ($op == 'insert') {
 ...
 $summary_id = $id;
    ...
    $id = mysqli_insert_id($con_main) :$id;
...
if ($sql) {
    ($op == "insert"){
            $self_update_main_module_code = mysqli_query($con_main, "UPDATE `match_summary` SET `summary_id`='$id' WHERE summary_id=$id");
