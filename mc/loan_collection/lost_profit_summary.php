...
<div id="page-content">
    ...
    <div class="content-header">
        <div class="header-section">
            <h1>
                <i class="gi gi-podium"></i>Profit & Loss  Summary Report<br>
            </h1>
        </div>
    </div>
    <ul class="breadcrumb breadcrumb-top">
        ...
        <li><li>Reports</li></li>
        <li><li>Profit & Loss Statement</li></li>
    </ul>
    <!-- END Blank Header -->
...
<form id="form-main" name="form-main" action="provider_crud.php" method="post"  class="form-horizontal form-bordered">
    ...
    <div class="form-group form-actions">
        <input type="hidden" name="report_url" id="report_url" value="reports/lost_profit_report.php"/>                  
            <div class="col-md-12">
