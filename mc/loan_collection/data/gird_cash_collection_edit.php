	<?php
		...
		$col_set = array('branch_name', 'center_name','loanid','nic','name_full','net_payment','paid','today');
	    ...
	    $query ="SELECT
                    ...
                    FROM
                    cash_collecting
                    INNER JOIN center ON cash_collecting.center_name = center.center_id
                    INNER JOIN branch ON cash_collecting.branch_name = branch.branch_id".$where." ".$order_by."
								LIMIT ".$start.", ".$length;
	  ...
	  $filtered_row_count_query = "SELECT
				                    ...
				                    cash_collecting
				                    INNER JOIN center ON cash_collecting.center_name = center.center_id
				                    INNER JOIN branch ON cash_collecting.branch_name = branch.branch_id".$where;
