...
<div id="page-content">
    ...
    <div class="content-header">
        <div class="header-section">
            <h1>
                <i class="gi gi-podium"></i>Income Master<br><small>Create, Update or Delete Expenses</small>
            </h1>
        </div>
    </div>
    <ul class="breadcrumb breadcrumb-top">
        <li><a href="../home.php">Home</a></li>
        <li><li>Income Category</li></li>
    </ul>
    <!-- END Blank Header -->
                                ...
                                <option></option>
                                   <?php
                                    ...
                                    while ($category = mysqli_fetch_assoc($sql)){
                                        ...
                                        echo ("<option value='".$category["category"]."'".($category["category"]=="other income"?"' selected='selected'>":"'>").$category["category"]."</option>");
                                    }
                                   ?>
                            </select>
                      </div> 
...
//         document.getElementById("category").value = "CATEGORY IS REQUIRED";
//         document.getElementById("category").style.color = "red";

//           $("#category").mousedown(function(){
              
//               $('#category').val('');
//               document.getElementById('category').style.borderColor = "blue";
...
//         $('#amount').val('');
//         document.getElementById('amount').style.borderColor = "blue";
...
//       document.getElementById("date").value = "DATE REQUIRED";
