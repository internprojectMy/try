...
<div id="page-wrapper"<?php if ($template['page_preloader']) { echo ' class="page-loading"'; } ?>>
    ...
    <div class="preloader themed-background">
        <h1 class="push-top-bottom text-light text-center"><?php echo ($company['SYSTEM_NAME_SHORT']); ?></h1>
        <div class="inner">
                ...
                <div class="sidebar-content">
                    ...
                    <ul class="chat-users clearfix">
                        <li>
                            <a href="javascript:void(0)" class="chat-user-online">
                                <span></span>
                                <img src="<?php echo($prefix); ?>img/placeholders/avatars/avatar12.jpg" alt="avatar" class="img-circle">
                            </a>
                        </li>
                        <li>
                            <a href="javascript:void(0)" class="chat-user-online">
                                <span></span>
                                <img src="<?php echo($prefix); ?>img/placeholders/avatars/avatar15.jpg" alt="avatar" class="img-circle">
                            </a>
                        </li>
                        <li>
                            <a href="javascript:void(0)" class="chat-user-online">
                                <span></span>
                                <img src="<?php echo($prefix); ?>img/placeholders/avatars/avatar10.jpg" alt="avatar" class="img-circle">
                            </a>
                        </li>
                        <li>
                            <a href="javascript:void(0)" class="chat-user-online">
                                <span></span>
                                <img src="<?php echo($prefix); ?>img/placeholders/avatars/avatar4.jpg" alt="avatar" class="img-circle">
                            </a>
                        </li>
                        <li>
                            <a href="javascript:void(0)" class="chat-user-away">
                                <span></span>
                                <img src="<?php echo($prefix); ?>img/placeholders/avatars/avatar7.jpg" alt="avatar" class="img-circle">
                            </a>
                        </li>
                        <li>
                            <a href="javascript:void(0)" class="chat-user-away">
                                <span></span>
                                <img src="<?php echo($prefix); ?>img/placeholders/avatars/avatar9.jpg" alt="avatar" class="img-circle">
                            </a>
                        </li>
                        <li>
                            <a href="javascript:void(0)" class="chat-user-busy">
                                <span></span>
                                <img src="<?php echo($prefix); ?>img/placeholders/avatars/avatar16.jpg" alt="avatar" class="img-circle">
                            </a>
                        </li>
                        <li>
                            <a href="javascript:void(0)">
                                <span></span>
                                <img src="<?php echo($prefix); ?>img/placeholders/avatars/avatar1.jpg" alt="avatar" class="img-circle">
                            </a>
                        </li>
                        <li>
                            <a href="javascript:void(0)">
                        ...
                        <li>
                            <a href="javascript:void(0)">
                                <span></span>
                                <img src="<?php echo($prefix); ?>img/placeholders/avatars/avatar3.jpg" alt="avatar" class="img-circle">
                            </a>
                        </li>
                        <li>
                            <a href="javascript:void(0)">
                                <span></span>
                                <img src="<?php echo($prefix); ?>img/placeholders/avatars/avatar13.jpg" alt="avatar" class="img-circle">
                            </a>
                        </li>
                        <li>
                            <a href="javascript:void(0)">
                    ...
                    <div class="chat-talk display-none">
                        ...
                        <div class="chat-talk-info sidebar-section">
                            ...
                            <img src="<?php echo($prefix); ?>img/placeholders/avatars/avatar5.jpg" alt="avatar" class="img-circle pull-left">
                        ...
                        <!-- Chat Input -->
                        <form action="<?php echo($prefix); ?>index.php" method="post" id="sidebar-chat-form" class="chat-form">
                    ...
                    <div class="sidebar-section">
                        ...
                        <div class="alert alert-warning alert-alt">
                            ...
                            <a href="<?php echo($prefix); ?>page_ready_pricing_tables.php" class="btn btn-xs btn-primary"><i class="fa fa-arrow-up"></i> Upgrade Plan</a>
                        </div>
                    </div>
                    <!-- END Activity -->
                    ...
                    <div class="sidebar-section">
                        <div class="alert alert-alt">
                            ...
                            <a href="<?php echo($prefix); ?>page_ready_inbox_message.php"><strong>New Follower</strong></a>
                        </div>
                        <div class="alert alert-alt">
                            Sarah Cole<small class="pull-right">2 min ago</small><br>
                            <a href="<?php echo($prefix); ?>page_ready_inbox_message.php"><strong>Your subscription was updated</strong></a>
                        </div>
                        <div class="alert alert-alt">
                            Bryan Porter<small class="pull-right">10 min ago</small><br>
                            <a href="<?php echo($prefix); ?>page_ready_inbox_message.php"><strong>A great opportunity</strong></a>
                        </div>
                        <div class="alert alert-alt">
                            Jose Duncan<small class="pull-right">30 min ago</small><br>
                            <a href="<?php echo($prefix); ?>page_ready_inbox_message.php"><strong>Account Activation</strong></a>
                        </div>
                        <div class="alert alert-alt">
                            Henry Ellis<small class="pull-right">40 min ago</small><br>
                            <a href="<?php echo($prefix); ?>page_ready_inbox_message.php"><strong>You reached 10.000 Followers!</strong></a>
                        </div>
                    </div>
                    <!-- END Messages -->
                </div>
            ...
            <div id="sidebar-scroll">
                ...
                <div class="sidebar-content">
                    ...
                    <a href="#" class="sidebar-brand">
                     <i class="gi gi-group"></i><span class="sidebar-nav-mini-hide">
                        <img src="img/pic3.png" width="120px"></span>
                    ...
                    <div class="sidebar-section sidebar-user clearfix sidebar-nav-mini-hide">
                        <div class="sidebar-user-avatar">
                            <a href="<?php echo($prefix); ?>page_ready_user_profile.php">
                                <?php
                                    $default_avatar_path = "img/placeholders/avatars/avatar2.jpg";
                                    
                                    if ($_SESSION['PHOTO_URL'] != NULL && !empty($_SESSION['PHOTO_URL'])){
                                        if (file_exists($prefix."admin/".$_SESSION['PHOTO_URL'])){
                                            echo ("<img src=\"".$prefix."admin/".$_SESSION['PHOTO_URL']."\" alt=\"User\">");
                                        }else{
                                            echo ("<img src=\"".$prefix.$default_avatar_path."\" alt=\"User\">");
                                        }
                                    }else{
                                        echo ("<img src=\"".$prefix.$default_avatar_path."\" alt=\"User\">");
                                    }
                        ...
                        <?php
                            $top_display_name = $_SESSION['FIRST_NAME']." ".$_SESSION['LAST_NAME'];
                            
                            $top_max_allow_char_count = 20;
                            $top_char_replace_start = 15;
                            
                            if (strlen($top_display_name) >= $top_max_allow_char_count){
                                if (strlen($_SESSION['FIRST_NAME']) >= $top_max_allow_char_count){
                                    $top_display_name = substr_replace($top_display_name,'...',$top_char_replace_start);
                                }else{
                                    $top_display_name = $_SESSION['FIRST_NAME'];
                                }
                            }

                            echo ($top_display_name);
                        ?>
                        </div>
                    ...
                    <ul class="sidebar-nav">
                        <?php foreach( $primary_nav as $key => $link ) {
                            ...
                            $url        = (isset($link['url']) && $link['url']) ? $prefix.$link['url'] : '#';
                        ...
                        <li<?php echo $li_active; ?>>
                            ...
                            <ul>
                                <?php foreach ($link['sub'] as $sub_link) {
                                    ...
                                    $url        = (isset($sub_link['url']) && $sub_link['url']) ? $prefix.$sub_link['url'] : '#';
                                    ...
                                    <?php if (isset($sub_link['sub']) && $sub_link['sub']) { ?>
                                        <ul>
                                            <?php foreach ($sub_link['sub'] as $sub2_link) {
                                                ...
                                                $url    = (isset($sub2_link['url']) && $sub2_link['url']) ? $prefix.$sub2_link['url'] : '#';
        ...
        <div id="main-container">
            ...
            <header class="navbar<?php if ($template['header_navbar']) { echo ' ' . $template['header_navbar']; } ?><?php if ($template['header']) { echo ' '. $template['header']; } ?>">
                ...
                <ul class="nav navbar-nav-custom pull-right">
                    ...
                    <li class="dropdown">
                        <a href="javascript:void(0)" class="dropdown-toggle" data-toggle="dropdown">
                            <img src="<?php echo($prefix); ?>img/placeholders/avatars/avatar2.jpg" alt="avatar"> <i class="fa fa-angle-down"></i>
                        </a>
                        <ul class="dropdown-menu dropdown-custom dropdown-menu-right">
                            <li class="dropdown-header text-center">Account</li>
                            <li>
                                <a href="<?php echo($prefix); ?>page_ready_timeline.php">
                                    <i class="fa fa-clock-o fa-fw pull-right"></i>
                                    <span class="badge pull-right">10</span>
                                    Updates
                                </a>
                                <a href="<?php echo($prefix); ?>page_ready_inbox.php">
                                ...
                                <a href="<?php echo($prefix); ?>page_ready_faq.php">
                            ...
                            <li class="divider"></li>
                            <li>
                                <a href="<?php echo($prefix); ?>page_ready_lock_screen.php"><i class="fa fa-lock fa-fw pull-right"></i> Lock Account</a>
                                <a href="<?php echo($prefix); ?>logout.php"><i class="fa fa-ban fa-fw pull-right"></i> Logout</a>
                            </li>
