...
<div id="page-content">
  <div class="content-header">
    <div class="header-section">
      <h1>
        <i class="gi gi-podium"></i>Invoice Report<br><small></small>
      </h1>
    </div>
   </div>
   ...
   <div class="row">
    <div class="col-md-12">
      <div class="block">
        ...
        <form id="form-main" name="form-main" action="excel_invoice.php" method="post"  class="form-horizontal form-bordered">
        ...
        <div class="form-group"> 
          <label class="col-md-2 control-label" for="fg_item">FG Item</label>        
           ...
           <label class="col-md-2 control-label" for="inv_type">Invoice Type</label>        
           <div class="col-md-2">                         
            <select id="inv_type" name="inv_type" class="select-chosen" data-placeholder>
              <option value="All" selected>All (Except Void)</option>
              <option value="VAT_CUSTOMER">VAT Registered</option>
              <option value="NON-VAT_CUSTOMER">Non VAT</option>
              <option value="SVAT_CUSTOMER">SVat</option>
          ...
          <div class="form-group"> 
           <label class="col-md-2 control-label" for="order_tp">Order Type</label>        
              ...
              <div class="form-group">
              <div class="col-md-5">
               <label class="radio-inline" for="quotation_payment">
                  <input type="radio" checked="radio" id="quotation_payment" name="payment_for" value="quotation_payment" onclick="getRadioId('quotation_payment')"> Summary
                      </label>
              ...
              <label class="radio-inline" for="quotation_payment">
                    <input type="radio" id="quotation_payment" name="payment_for" value="quotation_payment" onclick="getRadioId('quotation_payment')"> Detail 
                       </label></div></div>
          ...
          <div class="col-md-12">
            ...
            <marquee><b><font color="blue"> Invoice Report.<b> </marquee>
