...
$output2 .= '<th height="25" style="text-align:center;"><strong>CRN No</strong></th>';
$output2 .= '<th height="25" style="text-align:center;"><strong>CRN Date</strong></th>';
$output2 .= '<th height="25" style="text-align:center;"><strong>Quotation.No</strong></th>';
$output2 .= '<th height="25" style="text-align:center;"><strong>Actual Returned Qty</strong></th>';
$output2 .= '<th height="25" style="text-align:center;"><strong>Actual Return Date/Time</strong></th>';
$output2 .= '<th height="25" style="text-align:center;"><strong>Customer Complain Date</strong></th>';
$output2 .= '<th height="25" style="text-align:center;"><strong>Mode of Communi</strong></th>';
$output2 .= '<th height="25" style="text-align:center;"><strong>Name & Designation</strong></th>';
$output2 .= '</tr>'; 
$output2 .= '</thead>';
$output2 .= '<tbody>';
     ...
     $query ="SELECT
              ...
              LEFT JOIN customer_return_note ON customer_return_note.cra_id = customer_return_auth.id
              WHERE
  ...
  $output2 .= "<td style=\"text-align:center;\" colspan=\"1\" height=\"10\">".($work['date'])."</td>";
