...
<div id="page-content">
    ...
    <div class="content-header">
        <div class="header-section">
            <h1>
                <i class="gi gi-brush"></i>Groups<br><small>Add Group</small>
            </h1>
        </div>
    </div>
...
<div class="row">
    <div class="col-md-12">
        ...
        <div class="block">
                ...
                <form id="form-srevice-provider" name="form-connection-type" action="group_crud.php" method="post"  class="form-horizontal form-bordered" >
                   
						
                    <div class="form-group">
                        <label class="col-md-2 control-label" for="group">Group Name</label>
                        <div class="col-md-8">
                            <input id="group" name="group" class="form-control" placeholder="group" size="1">
