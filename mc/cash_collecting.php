    ...
    var dt = $('#table-data').DataTable({
        ...
        "columns": [
            ...
            { "data": "name_full", "name": "name_full", "title":"Customer Name"},//2
             { "data": "total", "name": "total", "title":"Loan Amount"},
          ...
          if(r.result){
            if(r.data.length>0){
             ...
             $.each(r.data,function(k,v){
                ...
                html += "<td><button type='button' class='btn btn-primary fuck'>Submit</button></td>";
                html += "</tr>";
  ...
  var amount = $('#total').val();
	...
	$('#form-main').on('submit', function (e){
      ...
      $('#rows tr').each(function(){
         ...
         var net_payment = obj['loan_amt']=$(this).find('td:eq(3)').html();
         var paid_amount = obj['pd_amt']=$(this).find('td input:eq(0)').val();
