...
<div class="row">
  <div class="column">
    <div class="card">
     ...
     <button class="btn"><a href="UserInterface.php">View Product Details</a></button>
    </div>
    </div>
   </div>
  ...
  <div class="column">
    <div class="card"> 
     ...
     <button class="btn"><a href="Supplyindex.php" > Details of Suppliers</a></button>
    </div>
    </div>
  </div>
  ...
  <div class="column">
    <div class="card">
     ...
     <button class="btn"><a href="category.php"> Details of Items</a></button>
    </div>
    </div>
  </div>
  ...
  <div class="column">
    <div class="card">
     ...
     <button class="btn"><a href="brand.php">Brands Details</a></button>
    </div>
    </div>
  </div>
   <div class="column">
    <div class="card">
     ...
     <button class="btn"><a href="product.php"> Details Of Product</a></button>
    </div>
    </div>
  </div>
  <div class="column">
    <div class="card">
     ...
     <button class="btn"> <a href="order.php" >Order details </a></button>
    </div>
    </div>
  </div>
