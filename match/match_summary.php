        ...
        <div class="col-md-12">
            <div class="block full">
                ...
                <form id="form-header" name="form-header" method="post" class="form-horizontal form-bordered">
                    ...
                    <label class="col-md-1 control-label" for="teamname">Team Name:</label>
                    <div class="col-md-2">
                    <select name="teamname" id="teamname" class="select-chosen" data-placeholder="Enter Emp status" >
                    <option value="">test</option>
                    <option value="">test</option>
                    <option value="">test</option>
                    </select>
                    ...
                    <option value="">1st Inning</option>
                    <option value=""> 2nd Inning</option>
                    <option value=""> T20 over</option>
                    </select>
                    </div>
                    ...
                    <div class="form-group">  
                     ...
                     <li>Bowlers Details </a></li>
                      ...
                      <div class="form-group">  
                        ...
                        <div class="col-md-4">
                            <input type="hidden" class="form-control" id="summary_id" name="summary_id" value="0">
                        </div>
                        <div class="col-md-6">
