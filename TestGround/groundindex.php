...
<div class="row">
	<div class="col-md-4">
		...
		<form action="groundaction.php" method="post" enctype="multipart/form-data">
    ...
    <tbody>
      ...
      <tr>
        ...
        <td><?= $row['phone']; ?></td>
        <td>
        <a href="grounddetails.php?details=<?= $row['id']; ?>" class="badge badge-primary p-3">Detils</a>
        <a href="groundaction.php?delete=<?= $row['id']; ?>" class="badge badge-danger p-3" onclick="return confirm('Do you want to delete this Record ??');">Delete</a>
